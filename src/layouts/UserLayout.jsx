...
const menuItems = [
  { title: 'Trang chủ', path: '/user/', icon: <DashboardIcon /> },
  { title: 'Đăng ký lớp học', path: '/user/classes', icon: <ClassIcon /> },
  { title: 'Điểm danh', path: '/user/attendance', icon: <EventNoteIcon /> },
  { title: 'Thanh toán', path: '/user/payments', icon: <PaymentIcon /> },
];
